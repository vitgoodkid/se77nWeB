...
const MODULES = [
  ...
  { id: 'travel', short: '03', accent: COLORS.gold,  icon: '◯', i18nLabel: 'nav.travel', i18nDesc: 'feature.travel.desc' },
...
const SLASH_COMMANDS = [
  ...
  { cmd: '/travel',    kind: 'nav', route: 'travel', accent: COLORS.gold,  desc: 'Jump · travel archive' },
...
export default function MobileShell() {
  ...
  const [route, setRoute] = useState(() => {
    ...
    return ['ai', 'tools', 'travel', 'game', 'tech', 'crypto', 'vault', 'todo'].includes(h) ? h : 'ai';
  });
  ...
  useEffect(() => {
    const onHash = () => {
      ...
      const next = ['ai', 'tools', 'travel', 'game', 'tech', 'crypto', 'vault', 'todo'].includes(h) ? h : 'ai';
