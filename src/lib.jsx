...
const I18N = {
  en: {
    ...
    'feature.game.desc':   'Tavern RP · Cờ Cá Ngựa',
    ...
    'tools.bmi.name':   'BMI Calculator',    'tools.bmi.desc':   'Body Mass Index from height & weight',
    'tools.convert.name': 'Converter',       'tools.convert.desc': 'Image (PNG/JPG/WebP/GIF) + Video/link → GIF/MP3',
    'tools.mic.name':   'Voice Recorder',    'tools.mic.desc':   'Record your mic → clean MP3 (noise cut + normalize)',
    'tools.hex.name':   'HEX → Text',         'tools.hex.desc':   'Decode hexadecimal bytes into UTF-8 text',
    'tools.2fa.name':   '2FA Authenticator',  'tools.2fa.desc':   'Generate a 6-digit TOTP code every 30 seconds',
    ...
    'nav.stylist':          'Stylist',
    'feature.stylist.desc': 'AI wardrobe · outfit mixer',
    'stylist.wardrobe':       'Wardrobe',
    'stylist.uploadHint':     'Upload photos of your clothes & accessories. AI turns each into a clean catalog item, then mixes them into outfits.',
    'stylist.upload':         'Upload',
    'stylist.empty':          'No pieces yet. Upload your first item.',
    'stylist.processing':     'styling…',
    'stylist.compose':        'COMPOSE AN OUTFIT',
    'stylist.occasionPh':     'What\'s the occasion? e.g. dinner date, smart casual…',
    'stylist.mix':            'Mix',
    'stylist.mixing':         'mixing',
    'stylist.needTwo':        'Add at least 2 finished items to mix an outfit.',
    'stylist.suggestions':    'SUGGESTED LOOKS',
    'stylist.saved':          'SAVED LOOKS',
    'stylist.pieces':         'pieces',
    'stylist.renderLookbook': 'Render lookbook',
    'stylist.rendering':      'rendering',
    'stylist.saveSet':        'Save',
    'stylist.delete':         'Delete',
    'stylist.noSets':         'Couldn\'t build a look from these pieces — try a different occasion or add more items.',
    'stylist.cat.top':        'Top',
    'stylist.cat.bottom':     'Bottom',
    'stylist.cat.outer':      'Outer',
    'stylist.cat.shoes':      'Shoes',
    'stylist.cat.accessory':  'Accessory',
    'stylist.character':      'CHARACTER',
    'stylist.charHint':       'Upload a photo (you or anyone) and enter a height. AI builds a character that models your lookbooks — and the height helps it pick better-fitting outfits.',
    'stylist.charNamePh':     'Name (optional)',
    'stylist.charHeightPh':   'Height in cm (required) — e.g. 170',
    'stylist.charCreate':     'Create character',
    'stylist.charCreating':   'creating',
    'stylist.charRemove':     'Remove character',
    'stylist.charDefault':    'My character',
    'stylist.charRegen':      'Regenerate character',
    'stylist.charTweakPh':    'Tweak (optional) — e.g. shorter hair, smiling…',
    'stylist.charPhotosHint': 'Add 1–4 photos — multiple face angles help the AI match your likeness.',
    'stylist.gender':         'GENDER',
    'stylist.body':           'BUILD',
    'stylist.skin':           'SKIN TONE',
    'stylist.retry':          'Retry',
    'stylist.save':           'Save',
    'stylist.cancel':         'Cancel',
    'stylist.edit':           'Edit',
    'stylist.pin':            'Pin (must include)',
    'stylist.exclude':        'Exclude',
    'stylist.pinned':         'pinned',
    'stylist.excluded':       'excluded',
    'stylist.clear':          'clear',
    'stylist.searchPh':       'Search wardrobe…',
    'stylist.all':            'All',
    'stylist.gapHint':        'Missing:',
    'stylist.preset.work':    'Work',
    'stylist.preset.date':    'Date',
    'stylist.preset.casual':  'Casual',
    'stylist.preset.gym':     'Gym',
    'stylist.preset.party':   'Party',
    'stylist.preset.formal':  'Formal',
    'stylist.advanced':       'ADVANCED',
    'stylist.formality':      'FORMALITY',
    'stylist.season':         'SEASON',
    'stylist.weatherPh':      'Weather (e.g. cold, rainy)',
    'stylist.colorPh':        'Color preference (e.g. earth tones)',
    'stylist.lookStyle':      'LOOKBOOK STYLE',
    'stylist.pose':           'POSE',
    'stylist.scene':          'SCENE',
    'stylist.framing':        'FRAMING',
    'stylist.ratio':          'RATIO',
    'stylist.shuffle':        'Shuffle',
    'stylist.moreLikeThis':   'More like this',
    'stylist.regenerate':     'Regenerate',
    'stylist.download':       'Download',
    'stylist.favourite':      'Favourite',
    'stylist.swap':           'Tap to swap',
    'stylist.swapWith':       'Swap with',
    'stylist.swapNone':       'No other items in this category.',
  },
  vi: {
    ...
    'feature.game.desc':   'Tavern nhập vai · Cờ Cá Ngựa',
    ...
    'tools.bmi.name':   'Tính BMI',          'tools.bmi.desc':   'Chỉ số khối cơ thể từ chiều cao & cân nặng',
    'tools.convert.name': 'Converter',       'tools.convert.desc': 'Ảnh (PNG/JPG/WebP/GIF) + Video/link → GIF/MP3',
    'tools.mic.name':   'Ghi âm giọng nói',  'tools.mic.desc':   'Thu mic → MP3 sạch (lọc ồn + cân âm lượng)',
    'tools.hex.name':   'HEX → Văn bản',      'tools.hex.desc':   'Giải mã chuỗi HEX thành văn bản UTF-8',
    'tools.2fa.name':   'Xác thực 2FA',        'tools.2fa.desc':   'Tạo mã TOTP 6 số, tự đổi sau mỗi 30 giây',
    'tools.thao.name':  'Thảo',              'tools.thao.desc':  'Gửi em yêu — cosmic letter',
    'tools.srv.name':   'Server',            'tools.srv.desc':   'Home lab dashboard',
    'tools.fin.name':   'Tài chính',         'tools.fin.desc':   'Net worth + tracking',

    'nav.stylist':          'Stylist',
    'feature.stylist.desc': 'Tủ đồ AI · phối outfit',
    'stylist.wardrobe':       'Tủ đồ',
    'stylist.uploadHint':     'Tải ảnh quần áo & phụ kiện của bạn lên. AI biến mỗi món thành ảnh catalog sạch, rồi phối thành outfit.',
    'stylist.upload':         'Tải lên',
    'stylist.empty':          'Chưa có món nào. Tải món đầu tiên lên.',
    'stylist.processing':     'đang xử lý…',
    'stylist.compose':        'PHỐI MỘT OUTFIT',
    'stylist.occasionPh':     'Dịp gì? vd: hẹn hò ăn tối, smart casual…',
    'stylist.mix':            'Phối',
    'stylist.mixing':         'đang phối',
    'stylist.needTwo':        'Cần ít nhất 2 món đã xử lý xong để phối đồ.',
    'stylist.suggestions':    'GỢI Ý OUTFIT',
    'stylist.saved':          'ĐÃ LƯU',
    'stylist.pieces':         'món',
    'stylist.renderLookbook': 'Tạo ảnh lookbook',
    'stylist.rendering':      'đang tạo',
    'stylist.saveSet':        'Lưu',
    'stylist.delete':         'Xoá',
    'stylist.noSets':         'Chưa phối được từ các món này — thử dịp khác hoặc thêm món.',
    'stylist.cat.top':        'Áo',
    'stylist.cat.bottom':     'Quần/Váy',
    'stylist.cat.outer':      'Khoác ngoài',
    'stylist.cat.shoes':      'Giày',
    'stylist.cat.accessory':  'Phụ kiện',
    'stylist.character':      'NHÂN VẬT',
    'stylist.charHint':       'Tải 1 ảnh (bạn hoặc bất kỳ ai) và nhập chiều cao. AI tạo một nhân vật làm người mẫu cho lookbook — chiều cao giúp AI chọn đồ vừa dáng hơn.',
    'stylist.charNamePh':     'Tên (tuỳ chọn)',
    'stylist.charHeightPh':   'Chiều cao (cm) — bắt buộc, vd 170',
    'stylist.charCreate':     'Tạo nhân vật',
    'stylist.charCreating':   'đang tạo',
    'stylist.charRemove':     'Xoá nhân vật',
    'stylist.charDefault':    'Nhân vật của tôi',
    'stylist.charRegen':      'Tạo lại nhân vật',
    'stylist.charTweakPh':    'Điều chỉnh (tuỳ chọn) — vd tóc ngắn hơn, cười…',
    'stylist.charPhotosHint': 'Thêm 1–4 ảnh — nhiều góc mặt giúp AI tạo giống bạn hơn.',
    'stylist.gender':         'GIỚI TÍNH',
    'stylist.body':           'DÁNG NGƯỜI',
    'stylist.skin':           'TÔNG DA',
    'stylist.retry':          'Thử lại',
    'stylist.save':           'Lưu',
    'stylist.cancel':         'Huỷ',
    'stylist.edit':           'Sửa',
    'stylist.pin':            'Ghim (bắt buộc có)',
    'stylist.exclude':        'Loại trừ',
    'stylist.pinned':         'đã ghim',
    'stylist.excluded':       'đã loại',
    'stylist.clear':          'xoá',
    'stylist.searchPh':       'Tìm trong tủ đồ…',
    'stylist.all':            'Tất cả',
    'stylist.gapHint':        'Còn thiếu:',
    'stylist.preset.work':    'Đi làm',
    'stylist.preset.date':    'Hẹn hò',
    'stylist.preset.casual':  'Dạo phố',
    'stylist.preset.gym':     'Gym',
    'stylist.preset.party':   'Tiệc',
    'stylist.preset.formal':  'Trang trọng',
    'stylist.advanced':       'NÂNG CAO',
    'stylist.formality':      'MỨC TRANG TRỌNG',
    'stylist.season':         'MÙA',
    'stylist.weatherPh':      'Thời tiết (vd lạnh, mưa)',
    'stylist.colorPh':        'Tông màu ưa thích (vd tông đất)',
    'stylist.lookStyle':      'KIỂU LOOKBOOK',
    'stylist.pose':           'TƯ THẾ',
    'stylist.scene':          'BỐI CẢNH',
    'stylist.framing':        'KHUNG HÌNH',
    'stylist.ratio':          'TỈ LỆ',
    'stylist.shuffle':        'Đổi bộ khác',
    'stylist.moreLikeThis':   'Tương tự bộ này',
    'stylist.regenerate':     'Tạo lại',
    'stylist.download':       'Tải về',
    'stylist.favourite':      'Yêu thích',
    'stylist.swap':           'Chạm để đổi món',
    'stylist.swapWith':       'Đổi bằng',
    'stylist.swapNone':       'Không có món khác cùng loại.',
  },
};
