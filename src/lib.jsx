...
const I18N = {
  en: {
    ...
    'tools.convert.name': 'Converter',       'tools.convert.desc': 'Image (PNG/JPG/WebP/GIF) + Video → GIF/MP3',
  ...
  vi: {
    ...
    'tools.convert.name': 'Converter',       'tools.convert.desc': 'Ảnh (PNG/JPG/WebP/GIF) + Video → GIF/MP3',
