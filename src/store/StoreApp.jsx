...
const PRODUCT_VIEW_GENS = [
  ...
  },
  {
    ...
    prompt: [
      ...
      'slim waist, natural feminine curves, fuller bust,',
      ...
      'Frame from about chest/shoulders to just below the hem of the product (close mid-shot). Do NOT shoot full body.',
      'Do NOT show underwear, panties, briefs, or a second competing garment that steals attention — crop them out or keep any bottom barely visible and plain dark.',
  ...
  },
  {
    ...
    prompt: [
      ...
      'Head-to-waist or tighter; never full-length legs. No visible underwear/panties; do not look like selling bottoms.',
